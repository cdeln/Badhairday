...
// Shaders
gtl::shader::IntegerHairTessVoxelizer hairVoxelizer;
gtl::shader::IntegerHairTessRenderer hairRenderShader;
...
#define toc(x) timer.toc(x); //glFinish()
...
void drawHair() {
    ...
    hairRenderShader.interpolate = backwardInterpolate;
